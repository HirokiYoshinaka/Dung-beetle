...
namespace Hunkoro
{
    namespace GameScene
    {
        public class SilverUnkoGenarator : MonoBehaviour
        {
            [SerializeField]
            private SilverUnkoController silverUnkoPrefab = null;
            [SerializeField]
            ...
            public void Genarate(Vector3 pos)
            {
                ...
                SilverUnkoController genarate = Instantiate(silverUnkoPrefab);
